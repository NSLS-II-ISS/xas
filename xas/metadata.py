...
metadata_dict = OrderedDict(
    {
        ...
        "sample_heater_1_T_sp": {
            ...
            "human_readable_key": "SampleHeater.temperature1.setpoint",
        },
        ...
        "sample_heater_2_T_sp": {
            ...
            "human_readable_key": "SampleHeater.temperature2.setpoint",
        },
        ...
        "gc_mfc_ch4_sp": {
            ...
            "human_readable_key": "SampleGasCart.MFC.CH4.setpoint",
        },
        "gc_mfc_ch4_rb": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:1}Gas:Flow-I",
            "human_readable_key": "SampleGasCart.MFC.CH4.readback",
        },
        "gc_mfc_co_sp": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:2}Gas:Flow-SP",
            "human_readable_key": "SampleGasCart.MFC.CO.setpoint",
        },
        "gc_mfc_co_rb": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:2}Gas:Flow-I",
            "human_readable_key": "SampleGasCart.MFC.CO.readback",
        },
        "gc_mfc_h2_sp": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:3}Gas:Flow-SP",
            "human_readable_key": "SampleGasCart.MFC.H2.setpoint",
        },
        "gc_mfc_h2_rb": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:3}Gas:Flow-I",
            "human_readable_key": "SampleGasCart.MFC.H2.readback",
        },
        "gc_mfc_exhaust_sp": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:4}Gas:Flow-SP",
            "human_readable_key": "SampleGasCart.MFC.exhaust.setpoint",
        },
        "gc_mfc_exhaust_rb": {
            "kind": "epics_pv",
            "pv_str": "XF:08IDB-CT{GC:1-MFC:4}Gas:Flow-I",
            "human_readable_key": "SampleGasCart.MFC.exhaust.readback",
        },
    }
)
...
for i in range(1, 17):
    _ghs_mfc_dict[f"ghs_mfc_{i}_sp"] = {
        ...
        "human_readable_key": f"SampleGasHandlingSystem.MFC{i}.setpoint",
    }
    _ghs_mfc_dict[f"ghs_mfc_{i}_rb"] = {
        "kind": "epics_pv",
        "pv_str": "XF:08IDB-UT{Gas:1-MFC:" + f"{i:02d}" + "}F-I",
        "human_readable_key": f"SampleGasHandlingSystem.MFC{i}.readback",
    }
