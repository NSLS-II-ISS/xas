...
def register_all_handlers(db):
    db.reg.register_handler("PIZZABOX_ENC_FILE_TXT_PD", PizzaBoxEncHandlerTxtPD, overwrite=True)
    ...
    db.reg.register_handler(ISSXspress3HDF5Handler.HANDLER_NAME, ISSXspress3HDF5Handler, overwrite=True)
